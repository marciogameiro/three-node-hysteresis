...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 8:
    # if len(sys.argv) < 10:
        print("./QueryAscending network_specification_file.txt partial_hysteresis_output_file.txt full_hysteresis_output_file.txt starting_rpi ending_rpi S_gene P_gene")
        # print("./QueryAscending network_specification_file.txt partial_hysteresis_output_file.txt partial_resettable_output_file.txt full_hysteresis_output_file.txt full_resettable_output_file.txt starting_rpi ending_rpi S_gene P_gene")
        exit(1)
